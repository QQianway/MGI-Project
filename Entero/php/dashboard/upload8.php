...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=7)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload tRNA sequences</h4>
                                <p class="category">Step 8 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload8action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
