                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload Details for Predicted Genes</h4>
                                <p class="category">Step 2 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload2action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
										<label class="control-label">Please upload the gff file</label>
