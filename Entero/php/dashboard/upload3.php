...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=2)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload the Amino Acid Sequences for Predicted Genes</h4>
                                <p class="category">Step 3 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload3action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
										<label class="control-label">Please ensure that the file contains amino acid sequences and is in fasta format</label>
