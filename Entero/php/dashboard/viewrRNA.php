...
<div class="wrapper">
	...
	<?php 
		require_once ("../config.php");
			$id=$_GET['id'];
			$id=$_GET['id'];
			$query = mysqli_query($conn,"select * from rrna where rRNAID='$id'");
			$rows = mysqli_fetch_array($query);
			$start=$rows['start'];
			$end=$rows['end'];
			$query2 = mysqli_query($conn, "select * from rrnaseq where tags like '%$start%' and tags like '%$end%' ");
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">rRNA <?php echo $_GET['id']; ?></h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="responstable">
                                    <tr>
										<th data-th="Scaffold ID"><span>Scaffold ID</span></th>
										<td><?php echo $rows['scaffoldID']?></td>
									</tr>
									<tr>
									...
									<?php			
										if (strpos($rows['source'],'FIG') !==false){
									...
									<?php	
										 ...
										 else if (strpos($rows['source'],'RNAmmer') !==false){
									?>
									<tr>
                                                                                <th data-th="Attribute"><span>Attribute</span></th>
									...
									?>
									<tr>
										<th data-th="Sequence"><span>Seqeunce</span></th>
