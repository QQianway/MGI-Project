    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-plain">
                            <div class="header">
                                <h4 class="title">Mapping Result of <?php echo $_GET['name']; ?></h4>
                            </div>
				<?php
					require_once ("../config.php");
					$name=$_GET['name'];
					$query = mysqli_query($conn,"select * from mapping where seqName='$name'");
					while($rows = mysqli_fetch_array($query)){
				?>
                            <div class="content table-responsive table-full-width">
                                <table class="responstable">
                                    <tr>
					<th data-th="HitName"><span>Hit Name</span></th>
					<td><?php echo $rows['hitName']?></td>
				</tr>
				<tr>
				...
				<tr>
					<th data-th="bit-score"><span>Bit Score</span></th>
					<td><?php echo $rows['bit-score']?></td>
				</tr>
				<tr>
					<th data-th="evalue"><span>Expected Value</span></th>
					<td><?php echo $rows['eValue']?></td>
				</tr>
				<tr>
					<th data-th="GOs"><span>GOs</span></th>
					<td>
					<?php	
						$GOsPiece=explode(',',$rows['GOs']);
						foreach($GOsPiece as $pieces){
					?>
					<!-- if link cannot open, modify a_href target here-->
					<a href="https://www.ebi.ac.uk/QuickGO/term/<?php echo $pieces;?>" target="_blank">
						<?php echo "$pieces, "?>
					</a>
					<?php
						}
