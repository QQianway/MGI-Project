...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=4)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload the Mapping file for Predicted Genes</h4>
                                <p class="category">Step 5 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload5action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
										<label class="control-label">The file can be exported from BLAST2GO. Please convert the file from txt to csv before uploading</label>
