...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=10)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload DNA plotter for each scaffold</h4>
                                <p class="category">Step 11 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload11action.php" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-12">
										<label class="control-label">Upload the picture of DNA for <?php echo $rows['scaffoldID']; ?>. Make sure the file is in jpg,png or gif format </label>
										<input type="file" name="<?php echo $rows['scaffoldID'] ?>" id="<?php echo $rows['scaffoldID'] ?>" class="form-control">
									</div>
								</div>
								<?php } ?>	
								<div class="row">
