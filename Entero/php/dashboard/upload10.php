...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=9)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload rRNA sequences</h4>
                                <p class="category">Step 10 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload10action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
										<label class="control-label">Please ensure that the file contains nucleotide sequences and is in fasta format</label>
