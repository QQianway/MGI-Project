...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=5)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload the BLAST2GO table</h4>
                                <p class="category">Step 6 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload6action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
