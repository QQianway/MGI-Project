...
<?php 
	...
	switch ($_SESSION['UPLOAD'])
	{
		...
		case 4:
			...
			break;
		case 5:
			header('Location: upload6.php');
			break;
		case 6:
			header('Location: upload7.php');
			break;
		case 7:
			header('Location: upload8.php');
			break;
		case 8:
			header('Location: upload9.php');
			break;
		case 9:
			header('Location: upload10.php');
			break;
		case 10:
			header('Location: upload11.php');
			break;
	}
?>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload Genome</h4>
                                <p class="category">Step 1 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload1action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-8">
										<label class="control-label">Genome Name</label>
										<input type="text" placeholder="Genome Name" class="form-control" name="genomename">
									</div>
									<div class="col-md-4">
										<label class="control-label">Genome Fasta File</label>
