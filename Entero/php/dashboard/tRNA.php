							...
							<div class="card card-plain">
								<div class="header">
									<h4 class="title"><?php 
										...
										echo "tRNA list for ".$rowtitle['genomeName']; 
											...
											<tr>
												<?php
												   ...
												   { 
														...
														while ($rows = mysqli_fetch_array($tRNAQuery))
														{
												?>
													<tr>
													<td class="rows"><a href="viewtRNA.php?id=<?php echo $rows['tRNAID']; ?>"><?php echo $rows['scaffoldID']."_".$rows['tRNAID']; ?></a></td>
								...
								<div class="content table-responsive table-full-width">
									<table class="table table-hover table-striped">
										...
										<tbody>
											<tr>
												<?php
													$tRNAQuery = mysqli_query($conn,"select * from trna where scaffoldID like '%$id%'");
													while ($rows = mysqli_fetch_array($tRNAQuery))
													{
												?>
													<tr>
