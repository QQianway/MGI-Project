...
<?php 
	...
	if (!isset($_SESSION['UPLOAD'])||$_SESSION['UPLOAD']!=6)
	{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="header">
                                <h4 class="title">Upload tRNA details</h4>
                                <p class="category">Step 7 of 11</p>
                            </div>
                            <div class="content">
								<form action="upload7action.php" method="post" enctype="multipart/form-data">
								<div class="row">
									<div class="col-md-12">
										<label class="control-label">Please upload the gff file for tRNA</label>
